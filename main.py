...
obj_loader_test = OBJLoader(r"models/test/untitled.obj", r"models/test/box.png", flip_textures=(True, True, True, True))
...
test_model = obj_loader_test.load()
        ...
        if event.type == pygame.QUIT:
            ...
            if controller.joysticks[0].get_button(5):  # Left bumper
                ...
                if selection_wheel.get_selected_item() == "D":
                    instances.append((test_model.add(renderer),
